# Ruby 安装
- [下载ruby2.3.1](https://ruby.taobao.org/)
 ```shell
 tar -zxf ruby-2.3.1.tar.gz     // 解压文件
 cd ruby-2.3.1                  // 进入文件夹
 ./configure                    // 自动配置 --pref-fix=/usr/local
 make                           // 编译
 make install                   // 安装

 gem install jekyll             // gem 安装jekyll
 gem install bundle             // gem 安装bundle
 ```
# Jekyll-Jacman
